...
public class ConsultaMatricula extends AppCompatActivity implements ChildEventListener, ValueEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyRecyclerViewAdapter(vehicles, dbParking, viewLlista, 2);
    ...
    public void onChildChanged(DataSnapshot dataSnapshot, String s) {
        Toast.makeText(ConsultaMatricula.this, "Has canviat " + dataSnapshot.getKey() + ": " + dataSnapshot.getValue(), Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onChildRemoved(DataSnapshot dataSnapshot) {
        Toast.makeText(ConsultaMatricula.this, "Has eliminat " + dataSnapshot.getKey() + ": " + dataSnapshot.getValue(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        Toast.makeText(ConsultaMatricula.this, "Hi ha " + dataSnapshot.getChildrenCount() + " vehicles a la llista", Toast.LENGTH_SHORT).show();
        if (vehicles.size() > 0) {
